...
pub const OpenGl3 = struct {
    ...
    pub fn deleteTextures(textures: []const TextureId) void {
        glDeleteTextures(@intCast(i32, textures.len), textures.ptr);
    }
    extern fn glDeleteTextures(usize, [*]const u32) void;

    pub fn textureParameteri(id: TextureId, pname: ValueType, param: ValueType) void {
        zimgui_glTextureParameteri(id, pname, param);
    }
    extern fn zimgui_glTextureParameteri(TextureId, ValueType, ValueType) void;

    pub fn textureParameterfv(id: TextureId, pname: ValueType, params: [*]const f32) void {
        zimgui_glTextureParameterfv(id, pname, params);
    }
    extern fn zimgui_glTextureParameterfv(TextureId, ValueType, [*]const f32) void;

    pub fn textureStorage2D(texture: TextureId, levels: i32, format: ValueType, width: i32, height: i32) void {
    ...
    pub fn textureSubImage2D(texture: TextureId, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: ValueType, type_: ValueType, pixels: *const anyopaque) void {
    ...
    pub fn pixelStorei(pname: ValueType, param: i32) void {
    ...
    pub fn drawElements(mode: ValueType, count: i32, type_: ValueType, indicies: *const anyopaque) void {
    ...
    pub fn uniform4fv(location: i32, value: [4]f32) void {
    ...
    pub fn createVertexArrays(arrays: []u32) void {
    ...
    ///
    pub fn enable(cap: ValueType) void {
        zimgui_glEnable(cap);
    }
