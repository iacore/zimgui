...
pub const OpenGl3 = struct {
    ...
    ) error{InvalidEnum, InvalidOperation, InvalidValue}!void {
    ...
    pub fn debugMessageCallback(
        callback: *const fn (source: ValueType, type_: ValueType, id: u32, severity: ValueType, length: i32, message: [*c]const u8, user_param: *const anyopaque) void,
